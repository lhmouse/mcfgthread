...
struct __MCF_shared_mutex
  {
#define __MCF_SHARED_MUTEX_NSHARE_M  16383U
    __MCF_EX uintptr_t __nshare : 14;  /* number of sharing threads  */

#define __MCF_SHARED_MUTEX_NSLEEP_M  (__MCF_UPTR_MAX >> 14)
    __MCF_EX uintptr_t __nsleep : __MCF_PTR_BITS - 14;  /* number of sleeping threads  */
  };

/* This special value indicates that the shared mutex has been locked in
 * exclusive mode.  */
#define __MCF_SHARED_MUTEX_NSHARE_EXCLUSIVE   16382U
