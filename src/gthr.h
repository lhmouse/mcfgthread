...
__MCF_ALIAS(__gthread_once, __MCF_gthr_once);
...
__MCF_ALIAS(__gthread_key_delete, __MCF_gthr_key_delete);
...
__MCF_ALIAS(__gthread_setspecific, __MCF_gthr_setspecific);
...
__MCF_ALIAS(__gthread_mutex_init, __MCF_gthr_mutex_init);
...
__MCF_ALIAS(__gthread_mutex_destroy, __MCF_gthr_mutex_destroy);
...
__MCF_ALIAS(__gthread_mutex_lock, __MCF_gthr_mutex_lock);
...
__MCF_ALIAS(__gthread_mutex_trylock, __MCF_gthr_mutex_trylock);
...
__MCF_ALIAS(__gthread_mutex_unlock, __MCF_gthr_mutex_unlock);
...
__MCF_ALIAS(__gthread_cond_destroy, __MCF_gthr_cond_destroy);
...
__MCF_ALIAS(__gthread_cond_wait, __MCF_gthr_cond_wait);
...
__MCF_ALIAS(__gthread_cond_timedwait, __MCF_gthr_cond_timedwait);
...
__MCF_ALIAS(__gthread_create, __MCF_gthr_create_v2);
...
__MCF_ALIAS(__gthread_join, __MCF_gthr_join_v2);
...
__MCF_ALIAS(__gthread_detach, __MCF_gthr_detach_v2);
...
__MCF_ALIAS(__gthread_yield, __MCF_gthr_yield);
