...
#define __MCF_ATOMIC_LOAD_PTR_RLX(p,m)   __atomic_load(m, p, __ATOMIC_RELAXED)
...
// Note the order of arguments is swapped. Output precedes input.
#define __MCF_ATOMIC_XCHG_PTR_RLX(p,m,r)   __atomic_exchange(m, r, p, __ATOMIC_RELAXED)
#define __MCF_ATOMIC_XCHG_PTR_ACQ(p,m,r)   __atomic_exchange(m, r, p, __ATOMIC_ACQUIRE)
#define __MCF_ATOMIC_XCHG_PTR_REL(p,m,r)   __atomic_exchange(m, r, p, __ATOMIC_RELEASE)
...
#define __MCF_ATOMIC_CMPXCHG_PTR_REL(m,c,p)   __atomic_compare_exchange(m, c, p, 0, __ATOMIC_RELEASE, __ATOMIC_RELAXED)
...
#define __MCF_ATOMIC_CMPXCHG_WEAK_ACQ(m,c,r)   __atomic_compare_exchange_n(m, c, r, 1, __ATOMIC_ACQUIRE, __ATOMIC_ACQUIRE)
#define __MCF_ATOMIC_CMPXCHG_WEAK_REL(m,c,r)   __atomic_compare_exchange_n(m, c, r, 1, __ATOMIC_RELEASE, __ATOMIC_RELAXED)
#define __MCF_ATOMIC_CMPXCHG_WEAK_ARL(m,c,r)   __atomic_compare_exchange_n(m, c, r, 1, __ATOMIC_ACQ_REL, __ATOMIC_ACQUIRE)
#define __MCF_ATOMIC_CMPXCHG_WEAK_CST(m,c,r)   __atomic_compare_exchange_n(m, c, r, 1, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST)
